 ...
 * @LastEditTime: 2020-06-09 15:00:58
  ...
  render() {
    return (
      ...
      <button onClick={this.changeDecimals0}>0位小数</button>
        ...
        <NumberInput delay={1000} onChange={v=>{console.log(v);this.setState({numberValue:v})}}  negative={true} maxLength={17} decimals={this.state.decimals}   returnType={this.state.returnType} value={this.state.numberValue} showTitle={true}/>
