 ...
 * @LastEditTime: 2021-06-21 11:59:25
...
class App1 extends React.Component {
  constructor(props) {
    ...
    this.state = { type:'text', v: 0, decimals: 3, visible: true, numberValue: '0', returnType: 'Number' };
  ...
  render() {
    return (
      ...
      <button onClick={this.changeDecimals0}>0位小数</button>
        ...
        <Input ref={ref=>this.inputRef = ref} type={this.state.type} className="texxt" />
        <select onChange={e=>{
