 ...
 * @LastEditTime: 2021-01-08 13:44:02
  ...
  render() {
    return (
      ...
      <button onClick={this.changeDecimals0}>0位小数</button>
        ...
        <NumberInput id="txb2" className="test2" spinner={true} step={0.001} delay={1000} onChange={v=>{console.log('change22:',v);}}  negative={true} maxLength={17} decimals={3} isFormat={true}  returnType={this.state.returnType} value={this.state.numberValue} showTitle={true}/>
