 ...
 * @LastEditTime: 2020-05-11 14:51:20
  ...
  render() {
    return (
      ...
      <button onClick={this.changeDecimals0}>0位小数</button>
        ...
        <NumberInput delay={true} onChange={v=>{console.log(v);this.setState({numberValue:v})}}  maxLength={7} decimals={this.state.decimals} isFormat={true}  negative={false} returnType={this.state.returnType} value={this.state.numberValue}/>
