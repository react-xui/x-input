 ...
 * @LastEditTime: 2020-04-30 10:54:34
  ...
  render() {
    return (
      ...
      <button onClick={this.changeDecimals0}>0位小数</button>
        ...
        <NumberInput maxLength={4} decimals={4} isFormat={true}  negative={false} returnType={this.state.returnType} value={this.state.numberValue}/>
