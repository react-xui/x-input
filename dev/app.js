 ...
 * @LastEditTime: 2020-05-12 17:55:01
  ...
  render() {
    return (
      ...
      <button onClick={this.changeDecimals0}>0位小数</button>
        ...
        <NumberInput delay={true} onChange={v=>{console.log(v);this.setState({numberValue:v})}}  negative={true} maxLength={17} decimals={this.state.decimals} isFormat={true}  returnType={this.state.returnType} value={this.state.numberValue}/>
