 ...
 * @LastEditTime: 2020-05-09 11:59:40
  ...
  render() {
    return (
      ...
      <button onClick={this.changeDecimals0}>0位小数</button>
        ...
        <NumberInput delay={true} onChange={v=>{console.log(v);this.setState({numberValue:v})}}  maxLength={7} decimals={4} isFormat={true}  negative={false} returnType={this.state.returnType} value={this.state.numberValue}/>
