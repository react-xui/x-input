            ...
            if (typeof addon !== 'undefined') {
                if ((typeof addon === "undefined" ? "undefined" : _typeof(addon)) === 'object') {
                    ...
                    return _react2.default.createElement(
                        "div",
                        { className: "x-input-addon-" + position },
                        addon
                    );
                } else {
                    //字符串或数值
                ...
                case 'text':
                    {
                        dom = _react2.default.createElement(
                            "div",
                            { className: className + " x-input-container" },
                            this.renderAddon('before', addonBefore),
                            _react2.default.createElement("input", _extends({}, props, { type: "text", value: this.state.value, className: cls })),
                            this.renderAddon('after', addonAfter)
                        );
                        break;
                    }
                case 'textarea':
                    {
                        dom = _react2.default.createElement(
                            ...
                            { className: className + " x-input-container" },
                            this.renderAddon('before', addonBefore),
                            _react2.default.createElement("textarea", _extends({}, props, { value: this.state.value, className: cls })),
                            this.renderAddon('after', addonAfter)
                        );
                        break;
                    }
                ...
                default:
                    {
                        return _react2.default.createElement(
                            ...
                            { className: className + " x-input-container" },
                            this.renderAddon('before', addonBefore),
                            _react2.default.createElement("input", _extends({}, props, { value: this.state.value, className: cls })),
                            this.renderAddon('after', addonAfter)
                        );
                        break;
                    }
